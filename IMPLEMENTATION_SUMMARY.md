...
- **Robustness fix (2026-04-19)** — PoisonEffect.Tick now throws ArgumentNullException when called with a null target; added tests to assert NullArgument behavior for both Poison and Stun ticks.
